  ...
  return (
    <button
      ...
      style={{
        width: "100%",
        padding: "20px 18px",
        background: disabled ? "#BFBAA8" : INK,
        color: "#fff",
        border: "none",
        borderRadius: 4,
        fontSize: 16,
    ...
    >
      ...
      <div style={{ padding: "12px 28px 22px" }}>
        ...
        >
          ...
          >
            <svg width="22" height="22" viewBox="0 0 22 22">
              ...
              <circle cx="11" cy="11" r="1.5" fill={INK} />
              <circle cx="18" cy="11" r="1.5" fill={INK} />
            </svg>
          </button>
        </div>
        <div style={{ marginTop: 28 }}>
          ...
          >
            진행 중인 여행{" "}
            <strong style={{ color: INK, fontWeight: 600 }}>1</strong>건 · 정산
            대기 금액{" "}
            <strong className="mono" style={{ color: INK, fontWeight: 600 }}>
              39,000원
            </strong>
          </p>
        </div>
      ...
      <div style={{ padding: "0 28px", flex: 1, overflowY: "auto" }}>
        ...
        >
          ...
          <span
            className="mono"
            style={{ fontSize: 11, color: MUTE, whiteSpace: "nowrap" }}
          >
            {rooms.length} TRIPS
          </span>
        </div>
        ...
        {rooms.map((r, idx) => (
          <button
            ...
            style={{
              ...
              display: "block",
              borderBottom:
                idx === rooms.length - 1 ? "none" : `1px solid ${LINE}`,
              fontFamily: "inherit",
            }}
          >
            <div
            ...
            >
              ...
              <div style={{ textAlign: "right", flexShrink: 0 }}>
                ...
                <div
                  className="mono"
                  style={{ fontSize: 10, color: MUTE, marginTop: 2 }}
                >
                  KRW
                </div>
              </div>
      ...
      >
        ...
        <PrimaryBtn onClick={onCreate}>
          ...
          <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span
              className="mono"
              style={{ fontSize: 12, opacity: 0.6, fontWeight: 500 }}
            >
              NEW
            </span>
    ...
    >
      ...
      <div style={{ padding: "4px 28px 24px" }}>
        ...
        >
          새 여행을
          <br />
          <span style={{ fontWeight: 300, color: MUTE }}>시작해볼까요?</span>
        </h2>
      </div>
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span
            className="mono"
            style={{ fontSize: 11, color: MUTE, letterSpacing: "0.1em" }}
          >
            LIVE
          </span>
        </div>
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20">
            ...
            <circle cx="16" cy="10" r="1.5" fill={INK} />
          </svg>
        </button>
      </div>
      ...
      <div style={{ padding: "6px 28px 18px" }}>
        ...
        >
          ...
          >
            ...
            <div
              className="mono"
              style={{ fontSize: 11, color: MUTE, marginTop: 2 }}
            >
              KRW · {room.expenses.length}건
            </div>
          </div>
        ...
        {filtered.map((e, i) => (
          <div
            ...
            style={{
              padding: "16px 0",
              borderBottom:
                i === filtered.length - 1 ? "none" : `1px solid ${LINE}`,
              display: "flex",
              alignItems: "center",
              gap: 12,
            }}
          >
            <div style={{ width: 36, flexShrink: 0 }}>
              <Caps style={{ fontSize: 9, color: MUTE, whiteSpace: "nowrap" }}>
                {e.category}
              </Caps>
              <div
                className="mono"
      ...
      >
        ...
        >
          ...
          <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <span
              className="mono"
              style={{ fontSize: 12, opacity: 0.55, fontWeight: 500 }}
            >
              {room.members.length}명
            </span>
            <Chevron dir="right" size={14} color="#fff" />
...
function AddExpenseSheet({
  ...
  const [participants, setParticipants] = useS(
    defaults?.participants || [...room.members],
  );
  ...
  const toggleP = (m) => {
    setParticipants((ps) =>
      ps.includes(m) ? ps.filter((x) => x !== m) : [...ps, m],
    );
  };
        ...
        >
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18">
              <path d="M2 2L16 16M16 2L2 16" stroke={INK} strokeWidth="1.6" />
            </svg>
          </button>
        </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "0 24px" }}>
          ...
          <div style={{ padding: "28px 0 8px", textAlign: "center" }}>
            ...
            {participants.length > 0 && numAmount > 0 && (
              <div
                className="mono"
                style={{ marginTop: 14, fontSize: 12, color: MUTE }}
              >
                1인당{" "}
          ...
          <div style={{ padding: "16px 0 24px" }}>
            ...
            >
              <Caps>
                참여 인원 ({participants.length}/{room.members.length})
              </Caps>
              <button
                onClick={toggleAll}
                style={{
